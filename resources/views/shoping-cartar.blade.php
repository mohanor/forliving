    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a href="{{ route('shoping.cart.ar')}}">محل</a></li>
            ...
            <div class="row row-rtl">
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            <li><a href="{{ route('products.indexar')}}">الصفحة الرئيسية</a></li>
                            <li class="active"><a href="{{ route('shoping.cart.ar')}}">السلة</a></li>
                            <li><a href="{{ route('contact.ar')}}">اتصل بنا</a></li>
                        </ul>
                    </nav>
                </div>
