    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__widget">
            ...
            <div class="header__top__right__auth">
                <a href="#"><i class="fa fa-user"></i> {{ __('Login')}}</a>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class="active"><a href="./shop-grid.html">{{ __('Shop')}}</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="./shop-details.html">Shop Details</a></li>
                                    <li><a href="./shoping-cart.html">Shoping Cart</a></li>
    ...
    <section class="checkout spad">
        <div class="container">
            <div class="checkout__form">
                ...
                <form action="{{ route('sendOrderNow')}}" method="POST">
                    @csrf
                    <input type="hidden" name="product" value="{{$order[0]->product}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                <h4>{{ __('Your Order')}}</h4>
                                <div class="checkout__order__products">{{ __('Products')}} <span>{{ __('Total')}}</span></div>
                                <ul>
                                    @foreach ($order as $item)
                                        <li>{{$item->title}} <span>{{ $item->price }} dh</span></li>
                                    @endforeach
                                </ul>
                                <div class="checkout__order__total">{{ __('Total')}} <span>{{$item->price}} dh</span></div>
                    ...
                    <div class="footer__copyright">
                        <div class="footer__copyright__text">
                            <p>
                                ...
                                by <a href="#" target="_blank">tiiit suit</a>
                            </p>
                        </div>
